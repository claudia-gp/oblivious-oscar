...
public class RopesAttached : MonoBehaviour {
	...
	public Delegates.EventHandler<Rope2D> OnRopePlugged;
	public Delegates.EventHandler<Rope2D> OnRopeUnplugged;
	public Delegates.EventHandler<Rope2D> OnIndirectRopeDestroyed;
	public Delegates.EventHandler<Rope2D> OnIndirectRopeCreated;

	public Delegates.EventHandler<Rope2D> OnIndirectRopeBreak;
	public Delegates.EventHandler<Rope2D, int> OnRopeBreak;
