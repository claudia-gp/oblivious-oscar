	...
	public class SceneManager : MonoBehaviour
	{
		...
		public static string CurrentLevelName
		{
			get
			{
				...
				#else
				if(!IsLoading() && UnityEngine.SceneManagement.SceneManager.GetActiveScene() != null && string.Equals(_currentLevelName, UnityEngine.SceneManagement.SceneManager.GetActiveScene().name))
