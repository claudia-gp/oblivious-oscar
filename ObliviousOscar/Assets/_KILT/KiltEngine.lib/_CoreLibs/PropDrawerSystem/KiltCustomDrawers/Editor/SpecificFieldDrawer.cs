...
public abstract class SpecificFieldDrawer : UnityEditor.PropertyDrawer
{
	...
	{
		DrawComponent(position, property, label, fieldInfo != null && fieldInfo.FieldType != null? fieldInfo.FieldType : typeof(object));
	}
	...
	protected virtual void CheckIfNeedRecalc(bool p_isArray)
	{
		...
		if(v_attr != null)
		{
			...
			System.Type v_type = this.fieldInfo !=null? this.fieldInfo.FieldType: typeof(object);
