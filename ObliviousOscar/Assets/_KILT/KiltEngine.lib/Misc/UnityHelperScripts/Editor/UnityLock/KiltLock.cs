...
[InitializeOnLoad]
public class KiltLock : EditorWindow
{
    const string lockMenuItem = "KILT/Locker/Lock GameObject";
	const string lockRecursivelyMenuItem = "KILT/Locker/Lock GameObject and Children %#l";
	const string unlockMenuItem = "KILT/Locker/Unlock GameObject";
	const string unlockRecursivelyMenuItem = "KILT/Locker/Unlock GameObject and Children %#u";
	...
	[MenuItem("KILT/Locker/Preferences")]
    static void ShowPreferences()
    {
		var window = GetWindow<KiltLock>();
    ...
    private static class HierarchyIcon
    {
        ...
        {
			drawingIcon = EditorPrefs.GetBool(KiltLock.showIconPrefKey);
        }
