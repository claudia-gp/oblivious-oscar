...
public class GlobalScheduler : MonoBehaviour {
	...
	public static void CallStaticFunction(System.Delegate v_functionPointer, float p_time, bool p_canCreateNewOne = true)
	{
		CallStaticFunction(v_functionPointer, null, p_time, p_canCreateNewOne);
	}

	public static void CallStaticFunction(System.Delegate v_functionPointer, List<object> p_params, float p_time, bool p_canCreateNewOne = true)
	{
		...
		if(v_instance != null)
		{
			...
			if(v_scheduler != null && Application.isPlaying)
			{
				...
				v_scheduler.FunctionToCall = v_functionPointer;
		...
		else
		{
			...
			v_newStruct.DelegatePointer = v_functionPointer;
	...
	public static void CallFunction(GameObject p_owner, System.Delegate v_functionPointer, float p_time, bool p_canCreateNewOne = true)
	{
		CallFunction(p_owner, v_functionPointer, null, p_time, p_canCreateNewOne);
	}

	public static void CallFunction(GameObject p_owner, System.Delegate v_functionPointer, List<object> p_params, float p_time, bool p_canCreateNewOne = true)
	{
		if(p_owner != null)
		{
			GlobalScheduler v_instance = GlobalScheduler.GetInstance(p_canCreateNewOne);
