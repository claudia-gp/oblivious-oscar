...
public static class KiltUtils
{
	...
	static AOTDictionaryKV<Assembly, System.Type[]> _assemblyTypesDict = null;
	public static AOTDictionaryKV<Assembly, System.Type[]> GetAssemblyTypesDict(bool p_forceRefresh = false)
	{
		if(_assemblyTypesDict == null || p_forceRefresh)
		{
			_assemblyTypesDict = new AOTDictionaryKV<Assembly, System.Type[]>();
			System.Reflection.Assembly[] v_assemblies = System.AppDomain.CurrentDomain.GetAssemblies();
			foreach(System.Reflection.Assembly v_assembly in v_assemblies)
			{
				if(v_assembly != null)
