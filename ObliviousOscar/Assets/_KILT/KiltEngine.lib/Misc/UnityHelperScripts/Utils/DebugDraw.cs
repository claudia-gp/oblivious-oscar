...
public class DebugDraw
{
	...
	static Material DebugMaterial
	{
		get
		{
			if(material == null)
			{
				material = (Material)Resources.Load("DebugDraw-Mat");
				if(material == null)
					material = new Material(Shader.Find("Kilt/DebugDraw"));
			}
			return material;
		}
	}
	...
	public static void DrawLine2D(Vector2 p_initialPosition, Vector2 p_finalPosition, Color p_color, int p_layer = 0)
	{
		DrawLine2D(p_initialPosition, p_finalPosition, p_color, new Color(1,1,0, p_color.a), p_layer);
	}
