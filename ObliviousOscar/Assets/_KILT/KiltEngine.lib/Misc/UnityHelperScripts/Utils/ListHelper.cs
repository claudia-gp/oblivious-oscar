...
public static class ListHelper {
	...
	public static void MergeList<T>(this List<T> p_list, List<T> p_otherList) where T : class
	{
		if(p_otherList != null)
		{
	...
	public static void UnmergeList<T>(this List<T> p_list, List<T> p_otherList) where T : class
	{
		if(p_otherList != null)
		{
