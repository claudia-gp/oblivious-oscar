...
public class SavePointsManager
{
	...
	static public Vector3 LatestPosition {
		get {
			return latestPositions [LevelManager.CurrentIndex];
		}
		set {
			latestPositions [LevelManager.CurrentIndex] = value;
		}
	}

	static public Vector3 InitialPosition {
		get {
			return initialPositions [LevelManager.CurrentIndex];
		}
		set {
			initialPositions [LevelManager.CurrentIndex] = value;
		}
	}

	static public bool HasLatestPosition {
		get {
			return latestPositions.ContainsKey (LevelManager.CurrentIndex);
		}
	}
}
